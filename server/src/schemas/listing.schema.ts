...
export const createListingSchema = z.object({
    ...
    bathroom_count: z.number().positive("bathroom count must be a positive number"),
    on_which_floor: z.number().nonnegative("on which floor must be a non-negative number"),
